...
* The original package name 'org.springframework.boot.spring-boot-starter-parent' is invalid and this project uses 'org.springframework.boot.springbootstarterparent' instead.
...
```
$ docker run --rm -p 8080:8080 spring-boot-starter-parent:0.0.1-SNAPSHOT
```
...
```
$ target/spring-boot-starter-parent
```
