...
public class MyDefaultConfig extends Converters implements Config {
    private final MyConfigSources configSources;

    private final MyConverters converters;

    MyDefaultConfig(MyConfigSources configSources, MyConverters converters) {
