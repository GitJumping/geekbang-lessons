...
public class MyConverters {
    ...
    public void register(Class<?> clazz, Converter<?> converter, int order) {
        if (cachedTypeConvertsMap.containsKey(clazz)) {
            ...
            while (iterator.hasNext()) {
                ...
                if (current instanceof MyOrderedConverter) {
                    int currentOrder = ((MyOrderedConverter) current).getOrder();
    ...
    public void register(Converter<?> converter) {
        ...
        int order = MyOrderedConverter.DEFAULT_ORDERED;
        if (converter instanceof MyOrderedConverter)
            order = ((MyOrderedConverter) converter).getOrder();
